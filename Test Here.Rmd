...
rproc <- Csnippet("
    ...
    l_bar_S = 1-q_S+(Y_S/(q_S*l_S*g00+q_E*l_E*g10+q_I*l_I*g20+q_R*l_R*g30+k_0)*q_S*g00+Y_E/(q_S*l_S*g01+q_E*l_E*g11+q_I*l_I*g21+q_R*l_R*g31+k_1)*q_E*g10+Y_I/(q_S*l_S*g02+q_E*l_E*g12+q_I*l_I*g22+q_R*l_R*g32+k_2)*q_I*g20+Y_R/(q_S*l_S*g03+q_E*l_E*g13+q_I*l_I*g23+q_R*l_R*g33+k_3)*q_R*g30)*l_S;
    l_bar_E = 1-q_E+(Y_S/(q_S*l_S*g00+q_E*l_E*g10+q_I*l_I*g20+q_R*l_R*g30+k_0)*q_S*g01+Y_E/(q_S*l_S*g01+q_E*l_E*g11+q_I*l_I*g21+q_R*l_R*g31+k_1)*q_E*g11+Y_I/(q_S*l_S*g02+q_E*l_E*g12+q_I*l_I*g22+q_R*l_R*g32+k_2)*q_I*g21+Y_R/(q_S*l_S*g03+q_E*l_E*g13+q_I*l_I*g23+q_R*l_R*g33+k_3)*q_R*g31)*l_E;
    l_bar_I = 1-q_I+(Y_S/(q_S*l_S*g00+q_E*l_E*g10+q_I*l_I*g20+q_R*l_R*g30+k_0)*q_S*g02+Y_E/(q_S*l_S*g01+q_E*l_E*g11+q_I*l_I*g21+q_R*l_R*g31+k_1)*q_E*g12+Y_I/(q_S*l_S*g02+q_E*l_E*g12+q_I*l_I*g22+q_R*l_R*g32+k_2)*q_I*g22+Y_R/(q_S*l_S*g03+q_E*l_E*g13+q_I*l_I*g23+q_R*l_R*g33+k_3)*q_R*g32)*l_I;
    l_bar_R = 1-q_R+(Y_S/(q_S*l_S*g00+q_E*l_E*g10+q_I*l_I*g20+q_R*l_R*g30+k_0)*q_S*g03+Y_E/(q_S*l_S*g01+q_E*l_E*g11+q_I*l_I*g21+q_R*l_R*g31+k_1)*q_E*g13+Y_I/(q_S*l_S*g02+q_E*l_E*g12+q_I*l_I*g22+q_R*l_R*g32+k_2)*q_I*g23+Y_R/(q_S*l_S*g03+q_E*l_E*g13+q_I*l_I*g23+q_R*l_R*g33+k_3)*q_R*g33)*l_R;
