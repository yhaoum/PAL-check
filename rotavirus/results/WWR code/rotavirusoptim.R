...
load('sim_data_ovov.Rdata')

run_level = 1
nstep = switch(run_level, 3, 6000)
...
coordinate_ascent <- Coordinate_ascent_algorithm2(a,c,initial_guess , nstep)

save(coordinate_ascent, file = "output/WWR_filter_sim_data_ovov.Rdata")
