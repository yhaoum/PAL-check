...
library(RcppDist)
library(ggplot2)
sourceCpp('rotavirus_sim_OvOv.cpp')
...
for(i in 1:1000){
  set.seed(123+765*i)
  rota_sim <- rotavirus_sim(length, 82372825, init_dist, betas, 66.89, 0.021, 0.14, 0.16)
...
write.csv(sim_compare, file = "sim_compare_WWR.csv")
...
p_OvOv_WWR <- ggplot(data=rota_sim) + 
