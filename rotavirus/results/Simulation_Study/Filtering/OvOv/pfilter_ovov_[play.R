...
load("~/Study/STATS 489/PAL-check/rotavirus/results/Simulation_Study/Filtering/OvOv/sim_list_100.Rdata")
realdat <- sim_list_100[[1]]
...
foreach(i=1:ncores, .combine=c,
  ...
  pfilter(m1,Np=50000,params=theta)
} -> pfs

x <- logLik(pfs)
# save(x, file = "pfilter_sim_100_ovov_2.Rdata")
