...
```{r}
sim_compare_EqEq <- read.csv("sim_compare_WWR_EqEq_old.csv")
sim_compare_pomp_EqEq <- read.csv("sim_compare_pomp_EqEq_old.csv")
```
...
pdf("compare_density_plot_EqEq_old.pdf",width=10,height=10)
...
pdf("two_random_simplots_EqEq.pdf", height=5,width=10)
...
sim_compare_pomp <- data.frame(avg_1,avg_2,avg_3,
                               med_1,med_2,med_3,
                               var_1,var_2,var_3)
write.csv(sim_compare_pomp, file = "sim_compare_pomp.csv")
```

#### Compare - OvOv

```{r}
sim_compare <- read.csv("sim_compare_WWR.csv", header = T)
sim_compare_pomp <- read.csv("sim_compare_pomp.csv", header = T)
```

```{r}
c(t.test(sim_compare$avg_1, sim_compare_pomp$avg_1)$p.value,
  ...
  t.test(sim_compare$var_3, sim_compare_pomp$var_3)$p.value)
```

```{r}
x <- data.frame(wwr=sim_compare$avg_1,pomp=sim_compare_pomp$avg_1)
data<- melt(x)
p_avg_1 <- ggplot(data,aes(x=value, fill=variable)) + geom_density(alpha=0.25)+ labs(x = "Mean Group 1 - OvOv") + ggtitle("p = 0.35953896")

x <- data.frame(wwr=sim_compare$avg_2,pomp=sim_compare_pomp$avg_2)
data<- melt(x)
p_avg_2 <- ggplot(data,aes(x=value, fill=variable)) + geom_density(alpha=0.25)+ labs(x = "Mean Group 2 - OvOv") + ggtitle("p = 0.36216770")

x <- data.frame(wwr=sim_compare$avg_3,pomp=sim_compare_pomp$avg_3)
data<- melt(x)
p_avg_3 <- ggplot(data,aes(x=value, fill=variable)) + geom_density(alpha=0.25)+ labs(x = "Mean Group 3 - OvOv") + ggtitle("p = 0.77373969")

x <- data.frame(wwr=sim_compare$med_1,pomp=sim_compare_pomp$med_1)
data<- melt(x)
p_med_1 <- ggplot(data,aes(x=value, fill=variable)) + geom_density(alpha=0.25)+ labs(x = "Median Group 1 - OvOv") + ggtitle("p = 0.07522447")

x <- data.frame(wwr=sim_compare$med_2,pomp=sim_compare_pomp$med_2)
data<- melt(x)
p_med_2 <- ggplot(data,aes(x=value, fill=variable)) + geom_density(alpha=0.25)+ labs(x = "Median Group 2 - OvOv") + ggtitle("p = 0.38945299")

x <- data.frame(wwr=sim_compare$med_3,pomp=sim_compare_pomp$med_3)
data<- melt(x)
p_med_3 <- ggplot(data,aes(x=value, fill=variable)) + geom_density(alpha=0.25)+ labs(x = "Median Group 3 - OvOv") + ggtitle("p = 0.10523030")

x <- data.frame(wwr=sim_compare$var_1,pomp=sim_compare_pomp$var_1)
data<- melt(x)
p_var_1 <- ggplot(data,aes(x=value, fill=variable)) + geom_density(alpha=0.25)+ labs(x = "Varience Group 1 - OvOv") + ggtitle("p = 0.58054332")

x <- data.frame(wwr=sim_compare$var_2,pomp=sim_compare_pomp$var_2)
data<- melt(x)
p_var_2 <- ggplot(data,aes(x=value, fill=variable)) + geom_density(alpha=0.25)+ labs(x = "Varience Group 2 - OvOv") + ggtitle("p = 0.92505732")

x <- data.frame(wwr=sim_compare$var_3,pomp=sim_compare_pomp$var_3)
data<- melt(x)
p_var_3 <- ggplot(data,aes(x=value, fill=variable)) + geom_density(alpha=0.25) + labs(x = "Varience Group 3 - OvOv") + ggtitle("p = 0.68643987")

pdf("compare_density_plot_OvOv.pdf",width=10,height=10)
plot <- ggarrange(p_avg_1,p_avg_2,p_avg_3,
          p_med_1,p_med_2,p_med_3,
          p_var_1,p_var_2,p_var_3, nrow=3, ncol=3)
