...
read.table("data/real_rotavirus_metadata.txt") %>%
...
### Next-round code
el <- readRDS("mif2_unknownrate_nb_el_01")
x <- na.omit(el$fits)
...
bake(file = "mif2_unknownrate_nb_02.rds",{ 
  mifs_global
})

bake(file = "mif2_unknownrate_nb_el_02.rds",{
