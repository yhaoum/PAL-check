...
RUN_LEVEL = 1
s=1 #shrunk for rw.sd
NP_MIF       = switch(RUN_LEVEL, 2, 10000)
NMIF         = switch(RUN_LEVEL, 2,  200)
...
bake(file = "output/binom/unknown_reporting/mif2_panel_Yize_report_binom_dummy.rds",{ 
  mifs_global
})

bake(file = "output/binom/unknown_reporting/mif2_panel_Yize_el_report_binom_dummy.rds",{
