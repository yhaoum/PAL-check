...
ggplot(data=sim_data) + 
  geom_line(aes(x=time, y=S1),color='green') +
  geom_line(aes(x=time, y=I1), color='red') +
  geom_line(aes(x=time, y=R1), color='blue') +
...
The estimated LL is $-10060.42$, which is reproted as $-10060.19$ as in Stocks(2020). Thus we have confirmed the St+St+ result is correctly reported. Next, we check StSt+. First trying to figure what's changed from St+ to St in states of X. Guess no 
