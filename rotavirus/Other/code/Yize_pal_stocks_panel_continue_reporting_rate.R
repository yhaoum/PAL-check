...
RUN_LEVEL = 2
NP_MIF       = switch(RUN_LEVEL, 4, 10000)
...
### Next-round code
el <- readRDS("output/round_01/mif2_panel_Yize_el_report_nb_01")
x <- na.omit(el$fits)
...
bake(file = "output/round_02/mif2_panel_Yize_report_nb_02.rds",{ 
  mifs_global
})

bake(file = "mif2_panel_Yize_el_report_nb_02.rds",{
