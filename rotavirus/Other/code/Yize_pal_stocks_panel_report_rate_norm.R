...
mifs_global <- foreach(i=1:cores,.packages='pomp', .options.multicore=mcopts) %dopar% {
  panelPomp::mif2(
    ...
    rw.sd = rw_sd(beta1=0.002,beta2=0.002,beta3=0.002,
                  beta11=0.001,phi=0.01, sigma=0.01, sigma_q=0.0002),
...
bake(file = "output/binom/round_01/mif2_panel_Yize_report_binom_dummy.rds",{ 
  mifs_global
})

bake(file = "output/binom/round_01/mif2_panel_Yize_el_report_binom_dummy.rds",{
