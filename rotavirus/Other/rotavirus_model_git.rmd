...
rproc <- Csnippet("
    ...
    double delta = 1 - 1/(18.86912*52.0);  // delta = 0.9989808
    double omega = 1/(1.0*52.0);         // omega = 0.01923077
    double dw = rgamma(sigma, 1/sigma);
    int I = I_1 + I_2 + I_3;
    int trans_S1[3], trans_S2[3], trans_S3[2], trans_I1[3], trans_I2[3], trans_I3[2], trans_R1[3], trans_R2[3], trans_R3[2];
    ...
    // Define rate
    prob_S1[0] = 1-exp(-Beta_1*I/N*dt*dw);
    prob_S1[1] = 1-exp(-dt*d_1);
    prob_S1[2] = exp(-dt*d_1) + exp(-Beta_1*I/N*dt*dw) - 1;
    ...
    prob_S2[0] = 1-exp(-Beta_2*I/N*dt*dw);
    prob_S2[1] = 1-exp(-dt*d_2);
    prob_S2[2] = exp(-dt*d_2) + exp(-Beta_2*I/N*dt*dw) - 1;
    ...
    prob_S3[0] = 1-exp(-Beta_3*I/N*dt*dw);
    prob_S3[1] = exp(-Beta_3*I/N*dt*dw);
